...
# Example usage:
folder_path = "/home/wiser-renjie/projects/yolov8/my/runs/my/test_error_handling_MOT"  # Replace with the path to your folder
output_file = "test_error_handling_MOT.mp4"
