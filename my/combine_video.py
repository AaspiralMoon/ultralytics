...
# Example usage:
folder_path = "/home/wiser-renjie/projects/yolov8/my/runs/my/MOT17-04-SDP_yolov8x"  # Replace with the path to your folder
output_file = "MOT17-04-SDP_yolov8x.mp4"
