...
destination_base_path = '/home/wiser-renjie/remote_datasets/MOT17_Det_YOLO/datasets_combined'
...
for seq in seqs:
    ...
    def copy_files(files, subset):
        for file in files:
            ...
            new_image_name = f'{folder_name.split("-")[1]}_{image_file}'
            new_label_name = f'{folder_name.split("-")[1]}_{label_file}'
