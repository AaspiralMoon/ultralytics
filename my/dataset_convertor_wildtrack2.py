...
# 源文件夹和目标文件夹路径
source_base_path = '/home/wiser-renjie/remote_datasets/wildtrack/datasets_separated'
destination_base_path = '/home/wiser-renjie/remote_datasets/wildtrack/datasets_combined'
